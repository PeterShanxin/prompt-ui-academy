  ...
  return (
    <section className="content-section learn-overview route-content-section" aria-labelledby="course-map-title">
      <div className="learn-summary">
        ...
        <Link href={nextLesson?.href ?? "/dictionary"}>{nextLesson ? pick(nextLesson.title, nextLesson.titleEn) : pick("复习 UI 词典", "Review the UI dictionary")} <ArrowIcon /></Link>
